...
<head>
    ...
    <title>Edit Carousel Slide | Donatellos Admin</title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h5 class="card-title fw-semibold mb-0">Edit Carousel Slide</h5>
                                    ...
                                    <form action="{{ route('carousel.update', $carousel) }}" method="POST">
                                            ...
                                            <select class="form-select" id="product_id" name="product_id" required>
                                                ...
                                                @foreach($products as $product)
                                                    <option value="{{ $product->id }}"
                                                        {{ old('product_id', $carousel->product_id) == $product->id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                rows="3" required maxlength="500">{{ old('description', $carousel->description) }}</textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="badge_text" name="badge_text"
                                                maxlength="100" value="{{ old('badge_text', $carousel->badge_text) }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="order" class="form-label">Order</label>
                                            <input type="number" class="form-control" id="order" name="order"
                                                min="0" value="{{ old('order', $carousel->order) }}" required>
